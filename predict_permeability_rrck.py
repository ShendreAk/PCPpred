...
def main():
    ...
    try:
        cwd = os.getcwd()
        smi_path = os.path.join(cwd, 'temp', 'Test_RRCK.smi')
        mol_dir = os.path.join(cwd, 'temp', 'Test_mol_RRCK')
        padel_2d_dir = os.path.join(cwd, "temp", "Test_2d_padel_RRCK.csv")
        padel_3d_dir = os.path.join(cwd, "temp", "Test_3d_padel_RRCK.csv")
        MODEL_DIR = os.path.join(cwd, 'models', 'RRCK')
